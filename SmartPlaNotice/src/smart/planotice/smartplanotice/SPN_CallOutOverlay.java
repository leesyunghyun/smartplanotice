...
public class SPN_CallOutOverlay extends NMapCalloutOverlay {

	private static final int CALLOUT_TEXT_PADDING_X = 10;
	private static final int CALLOUT_TEXT_PADDING_Y = 10;
	private static final int CALLOUT_TAG_WIDTH = 15;
	private static final int CALLOUT_TAG_HEIGHT = 15;
	private static final int CALLOUT_ROUND_RADIUS_X = 30;
	private static final int CALLOUT_ROUND_RADIUS_Y = 30;

	private final Paint mInnerPaint, mBorderPaint, mTextPaint;
	private final Path mPath;
	private float mOffsetX, mOffsetY;

	public SPN_CallOutOverlay(NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds) {
